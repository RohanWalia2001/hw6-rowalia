...
static const Cache::size_type maxmem = 16777216;
...
REQUIRE(set_data(cache)
== true);
REQUIRE(data_are_valid(cache)
== true);  // FAIL
REQUIRE(del_data(cache)
== true);
REQUIRE(cache
->
